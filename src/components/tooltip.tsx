 ...
 *
 * @ai-context
 * - px-3(12px) py-2(8px) — on 4px sub-grid
 * - Wrap app in TooltipProvider once, each Tooltip needs Trigger + Content
 * - Content portals to body with enter/exit animations
